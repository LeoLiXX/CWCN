...
public final class CwRecording3SqlSweepProbeTest {
    ...
    @Test
    public void printRecording3SqlSweep() throws Exception {
        ...
        System.out.println("==== recording3 sql sweep ====");
        for (int sqlPercent : SQL_LEVELS) {
            ...
            System.out.println(String.format(
                    Locale.US,
                    "sql=%d recall=%.4f chars=%d turns=%d trust=%s dot=%s tone=%d/%d/%d wpm=%d on=%d off=%d bi9cms=%d bi9clt=%d ur=%d rst=%d bk=%d rejects=%s",
                    sqlPercent,
                    recall,
