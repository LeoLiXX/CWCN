    ...
    public void printCurrentDecodeSummaryForAllConvertedLocalAudioFiles() throws Exception {
        ...
        for (Path wavFile : wavFiles) {
            ...
            markdown.append("## ")
                    ...
                    .append(", hypTone=").append(result.signalSnapshot().toneHypothesisFrequencyHz()).append("Hz")
                    .append(", hypConf=").append(String.format(java.util.Locale.US, "%.2f", result.signalSnapshot().toneHypothesisConfidence()))
                    .append(", hypFrames=").append(result.signalSnapshot().toneHypothesisSupportFrames())
                    .append(", hypIdle=").append(result.signalSnapshot().toneHypothesisIdleFrames())
                    .append(", hypSource=").append(result.signalSnapshot().toneHypothesisSource())
