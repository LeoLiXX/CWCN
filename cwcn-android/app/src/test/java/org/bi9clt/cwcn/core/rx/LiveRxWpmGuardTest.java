...
public final class LiveRxWpmGuardTest {
    ...
    @Test
    public void startupWeakConfidenceRunawayDoesNotLeapFarAboveSeedBeforeTrustExists() {
        LiveRxWpmGuard guard = new LiveRxWpmGuard();
        guard.setSeedWpm(24);
        ...
        assertEquals(24, displayWpm);
        assertFalse(guard.holding());
    }

    @Test
    public void startupStrongConfidenceStillCapsRunawayBeforeTrustExists() {
        LiveRxWpmGuard guard = new LiveRxWpmGuard();
        guard.setSeedWpm(15);
    ...
    @Test
    public void startupFreezesTimingLearningWhenRawAlreadyHitsInitialRunawayBand() {
        LiveRxWpmGuard guard = new LiveRxWpmGuard();
        guard.setSeedWpm(15);
        ...
        assertFalse(guard.shouldAllowTimingLearning(weakSignal, timingSnapshot(27.0d), 800L));
    }
